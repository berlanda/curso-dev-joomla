...
$canOrder = $user->authorise('core.edit.state', 'com_biblioteca.category');
$saveOrder = $listOrder == 'a.ordering';
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_biblioteca&task=livros.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'livroList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
   	...
   	<?php endif;?>
   		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				...
				echo JText::_('COM_BIBLIOTECA_SEARCH_IN_TITLE');?></label>
			...
			<div class="btn-group pull-left">
				...
				JText::_('JSEARCH_FILTER_SUBMIT'); ?>"><i class="icon-search"></i></button>
			...
			<div class="btn-group pull-right hidden-phone">
				...
				<select name="directionTable" id="directionTable" class="input-medium" onchange="Joomla.orderTable()">
					...
					'selected="selected"'; ?>><?php echo JText::_('JGLOBAL_ORDER_ASCENDING');?></option>
					<option value="desc" <?php if ($listDirn == 'desc') echo
					'selected="selected"'; ?>><?php echo JText::_('JGLOBAL_ORDER_DESCENDING');?></option>
				</select>
			</div>
			...
			<thead>
				<tr>
					...
					<th class="nowrap hidden-phone">
			            <?php echo JHtml::_('grid.sort', 'COM_BIBLIOTECA_HEADING_AUTOR',
			            'd.nome', $listDirn, $listOrder); ?>
			        </th>
			        <th class="nowrap hidden-phone">
			            <?php echo JHtml::_('grid.sort', 'COM_BIBLIOTECA_HEADING_CATEGORY',
			            'c.title', $listDirn, $listOrder); ?>
			        </th>
					<th class="nowrap hidden-phone">
			            <?php echo JHtml::_('grid.sort', 'COM_BIBLIOTECA_HEADING_EDITORA',
			...
			<tbody>
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
					...
					<td class="center">
            			...
            			'livros.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
          			</td>
					<td class="nowrap has-context">
						<?php if ($canEdit) : ?>
							<a href="<?php echo JRoute::_('index.php?option=com_biblioteca&task=livro.edit&id='.(int) $item->id); ?>">
