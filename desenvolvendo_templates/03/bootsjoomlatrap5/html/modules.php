...
function modChrome_menuTopo($module, &$params, &$attribs)
{
	if (!empty ($module->content)) : ?>
		<div class="nav-scroller py-1 mb-2 menuTopo moduletable<?php echo htmlspecialchars($params->get('moduleclass_sfx', ''), ENT_COMPAT, 'UTF-8'); ?>">
			<?php echo $module->content; ?>
		</div>
	<?php endif;
}