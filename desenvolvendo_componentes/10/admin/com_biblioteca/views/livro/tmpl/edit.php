...
?>
<form action="<?php echo JRoute::_('index.php?option=com_biblioteca&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset>
				...
				<?php echo JHtml::_('bootstrap.addPanel', 'myTab',
					...
					JText::_('COM_BIBLIOTECA_NEW_LIVRO', true) :
					JText::sprintf('COM_BIBLIOTECA_EDIT_LIVRO',
					$this->item->id, true));
				?>
				<?php
				/*
