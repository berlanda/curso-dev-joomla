...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_biblioteca&task=autores.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'autorList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_biblioteca&view=autores'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="livroList">
			<thead>
				<tr>
					...
					<th class="title">
						<?php echo JHtml::_('grid.sort', 'COM_BIBLIOTECA_HEADING_AUTOR_NOME',
			...
			<tbody>
				<?php foreach ($this->items as $i => $item) :
					...
					$canEdit    = $user->authorise('core.edit', 'com_biblioteca');
				?>
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
					...
					<td class="center">
            			...
            			'autores.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
          			</td>
					<td class="nowrap has-context">
						<?php if ($canEdit) : ?>
							<a href="<?php echo JRoute::_('index.php?option=com_biblioteca&task=autor.edit&id='.(int) $item->id); ?>">
